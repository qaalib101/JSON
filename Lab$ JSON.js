...
rates.CHF = 1.1787;
// 100 euros
var euros = 100 * rates.AUD;
console.log("This is how much auds is 100 euros " + euros);

var maxRate = rates.AUD;
for(var exchange in rates){

    if(maxRate < rates[exchange]){
        maxRate = rates[exchange];
    }
}
...
for(var x = 0; x < cats_and_owners.length; x++){
    console.log(JSON.stringify(cats_and_owners[x]));
}
...
for(var component in nobel_prize_winners_2017.prizes){
    if(nobel_prize_winners_2017.prizes[component].category == "literature"){
        var fullName = "";
        for(var position in nobel_prize_winners_2017.prizes[component].laureates){
            fullName = nobel_prize_winners_2017.prizes[component].laureates[position].firstname + " "
                + nobel_prize_winners_2017.prizes[component].laureates[position].surname;
        }
        console.log(fullName);
    }
    if(nobel_prize_winners_2017.prizes[component].category == "physics"){
        for(var position in nobel_prize_winners_2017.prizes[component].laureates){
            var physics_id = nobel_prize_winners_2017.prizes[component].laureates[position].id;
            console.log(physics_id);
        }
    }
}
for(var component in nobel_prize_winners_2017.prizes){
    console.log(nobel_prize_winners_2017.prizes[component].category);
}
console.log(nobel_prize_winners_2017.prizes.length);
var iteration = 0;
for(var component in nobel_prize_winners_2017.prizes){
    iteration = iteration + nobel_prize_winners_2017.prizes[component].laureates.length;
}
